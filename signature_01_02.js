...
var params = {
    ...
    navigator:{
        appCodeName: "Mozilla",
        appName: "Netscape",
        appVersion: "5.0 (Macintosh; Intel Mac OS X 11_0_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36",
        cookieEnabled: true,
...
Object.assign(window,params);
 ...
 //这里的 process.argv[3] 是从外部获取参数，我的 js 执行命令是： node sign.js url cookie
 cookies = 'ttcid=4b8b65227087420fb63f3f0ec368f4e311; ttwid=1%7CWHNlOdqVy3MEdCsNpZnYJdFGeBDFPmJI90hhNr43IMk%7C1605490504%7Cd419df7acad9060eb796fca8e0db8afc8fec55da5a57b774ccba45a652019412; tt_webid=7d0a1b23e9966d1ab52c3ef39a3e1b67; d_ticket=141bc67a0a428df04b4c92772cccee5578d05; gfsitesid=NDgzY2FkNGFkZnwxNjA4MTc3NTMyNTB8fDAGBgYGBgY; gfpart_1.0.0.310_24252=1; gfpart_1.0.0.338_26286=1; SLARDAR_WEB_ID=unLoggedUser; gfpart_1.0.0.922_26339=0; gfpart_1.0.0.932_26551=0; n_mh=quHkJ0w0NMFpo8uvWDb2MFZgiuwzrsju5IxQxCHBnGY; uid_tt=786b2456d0d525ae6eb649ff7786f17c; uid_tt_ss=786b2456d0d525ae6eb649ff7786f17c; sid_tt=537c98bad9dbee5182d3224e13ce20e1; sessionid=537c98bad9dbee5182d3224e13ce20e1; sessionid_ss=537c98bad9dbee5182d3224e13ce20e1; odin_tt=dec7440fa7d88eab1892a009b5113fbd16f7a1bece321a77d05f75441156df24f0e6e0bf07394042f923a9a7e0653d8c6db46bde2c9aa4e5a52105f8d52e3bc4; sid_guard=537c98bad9dbee5182d3224e13ce20e1%7C1610586182%7C5184000%7CMon%2C+15-Mar-2021+01%3A03%3A02+GMT; PHPSESSID=5223599a6b116cafb032239cc8ee09db; PHPSESSID_SS=5223599a6b116cafb032239cc8ee09db; gfpart_1.0.0.713_28267=0; gfpart_1.0.0.992_28799=0; MONITOR_WEB_ID=04a75a8f-7e9b-4111-adf2-44d4306725ed; gfpart_1.0.0.3558_30827=0; gfpart_1.0.0.1058_30828=0; gfpart_1.0.0.759_31042=0; Hm_lvt_b6520b076191ab4b36812da4c90f7a5e=1611228601,1611473040; Hm_lpvt_b6520b076191ab4b36812da4c90f7a5e=1611473040; tt_scid=x0NMMrnwUPUX5FybNXvjcK6ExBaWnSSPdo4E18HfhgyW5Lbx.uEbGnX.tEyRwDYif1b6; gftoken=NTM3Yzk4YmFkOXwxNjExNDczNzk0NTV8fDAGBgYGBgY';
...
base_url = "https://fxg.jinritemai.com/shopuser/aftersale/searchlist?aftersale_status=&aftersale_type=&reason=&order_flag=&logistics_status=&pay_type=&refund_type=&arbitrate_status=&apply_time_start=1610121600&apply_time_end=1611417599&page=1&pageSize=10&appid=1&__token=54b23dfca4baac06a025974839772ac5&_lid=738618650668"
sign = window.byted_acrawler.sign({url: base_url});
console.log(sign);
...
//
//    res.json({'code': 401, 'data': '请使用post方法传入字符串'})
//
//});
//
////处理post请求
...
//        if (formdata) {
//            key = window.byted_acrawler.sign({url: formdata.replace(/toutiao.com/, "toutiao.com/toutiao")})
//            console.log(
//                "传过来的数值为: %s", formdata
//            );
//            console.log('signature' + key);
//            res.json({'code': 200, 'key': key})
//        } else {
//            res.json({'code': 901, 'error': '缺少字段'})
//        }
//
//    }catch{
//        res.json({'code': 601, 'error': '请求出错'})
//    }
//});
//
//app.listen(4190, '0.0.0.0');

// console.log('https://www.toutiao.com/api/pc/feed/?category=profile_all&utm_source=toutiao&visit_user_token=MS4wLjABAAAAZ-7_bvIhGk-tKa7Z4B3GUSA0d-6Rc3qMsEsMEPPUQig&max_behot_time=0&_signature=' + window.byted_acrawler.sign({'url': 'https://www.toutiao.com/toutiao/api/pc/feed/?category=profile_all&utm_source=toutiao&visit_user_token=MS4wLjABAAAAZ-7_bvIhGk-tKa7Z4B3GUSA0d-6Rc3qMsEsMEPPUQig&max_behot_time=0'}))
